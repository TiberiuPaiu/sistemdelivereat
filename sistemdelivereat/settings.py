"""
Django settings for sistemdelivereat project.
...
SECRET_KEY = 'django-insecure-10t1zh6eu$^qp#uk%@7h5j1g6smhyc6t3_&rx_0e^-ak!%gtf)'
...
ROOT_URLCONF = 'sistemdelivereat.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'myapp.templatetags.context_processors.carrito_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'sistemdelivereat.wsgi.application'
...
# Configuracion necesaria para hacer una abstracion del user auth
